...
<header>
    <h1>Neptune Hotel</h1>
    <div id=boutons>
        <a href="reservation.ut.php"><input type="submit" name="Contact " value="réservation"></a>
        <a href="profil.php"> <input type="submit" name="Compte" value="mon compte"></a>
        <a href="contact.php"><input type="submit" name="contact" value="nous contacter"></a>
    </div>
</header>
<main>
    <div id="fond"></div>
            ...
            if ($chambres) {
                foreach ($chambres as $chambre) {
                    ...
                    <div id="infos">
                        ...
                        <a href="chambre.ut.php?id=<?=$numero?>"><input type="submit" name="Chambre " value="plus de détails"></a>
