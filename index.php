...
<body>
    <header>
        <h1>Neptune Hotel</h1>
        <div id=boutons>
            <a href="php/reservation.ut.php"><input type="submit" name="Contact " value="réservation"></a>
            <a href="php/connexion.php"> <input type="submit" name="Mon compte" value="se connecter"></a>
            <a href="php/contact.php"><input type="submit" name="" value="nous contacter"></a>
        </div>
    </header>
    <main>
        <div id="fond"></div>
                ...
                if ($chambres) {
                    foreach ($chambres as $chambre) {
                        ...
                        <div id="infos">
                            ...
                            <a href="php/chambre.php?id=<?=$numero?>"><input type="submit" name="Chambre " value="plus de détails"></a>
